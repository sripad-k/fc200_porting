...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180308, 0x000198C3U ,0x000198C3U)
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CLK_CTRL_OFFSET,
		0x000198C3U, 0x000198C3U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL0_REF_CTRL_DIVISOR0                           0x11
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C0, 0x013F3F07U ,0x01011100U)
    */
	PSU_Mask_Write(CRL_APB_PL0_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01011100U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * only.
    *  PSU_DDRC_INIT6_MR5                                          0x16c0

    * SDRAM Initialization Register 6
    * (OFFSET, MASK, VALUE)      (0XFD0700E8, 0xFFFFFFFFU ,0x000016C0U)
    */
	PSU_Mask_Write(DDRC_INIT6_OFFSET, 0xFFFFFFFFU, 0x000016C0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x0F082412U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x0F082412U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0701C0, 0x00000007U ,0x00000005U)
    */
	PSU_Mask_Write(DDRC_DBICTL_OFFSET, 0x00000007U, 0x00000005U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x28100008U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x28100008U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080194, 0xFFFFFFFFU ,0x000016C0U)
    */
	PSU_Mask_Write(DDR_PHY_MR5_OFFSET, 0xFFFFFFFFU, 0x000016C0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * atabus)
    *  PSU_IOU_SLCR_MIO_PIN_27_L3_SEL                              4

    * Configures MIO Pin 27 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18006C, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_27_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_28_L3_SEL                              4

    * Configures MIO Pin 28 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180070, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_28_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_42_L3_SEL                              1

    * Configures MIO Pin 42 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800A8, 0x000000FEU ,0x00000020U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_42_OFFSET, 0x000000FEU, 0x00000020U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_43_L3_SEL                              1

    * Configures MIO Pin 43 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800AC, 0x000000FEU ,0x00000020U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_43_OFFSET, 0x000000FEU, 0x00000020U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00000600U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00000600U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18013C, 0x03FFFFFFU ,0x00000400U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL1_OFFSET,
		0x03FFFFFFU, 0x00000400U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180158, 0x03FFFFFFU ,0x00018000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL1_OFFSET,
		0x03FFFFFFU, 0x00018000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180164, 0x03FFFFFFU ,0x01E7BFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL5_OFFSET,
		0x03FFFFFFU, 0x01E7BFFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180160, 0x03FFF79EU ,0x03FFF38EU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL4_OFFSET,
		0x03FFF79EU, 0x03FFF38EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(0,0,5,0,5,0,2,3);
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD410010, 0x00000077U ,0x00000052U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000077U, 0x00000052U);
/*##################################################################### */
...
/*Vref training is complete, disabling static read mode*/
	...
	*/
	...
	DQ8RBD_0 = (Xil_In32(0xFD080F50U) & 0x0000003FU) >> 0x00000000U;
	int DQ8RBD_1;

	DQ8RBD_1 = (Xil_In32(0xFD080F50U) & 0x00003F00U) >> 0x00000008U;
	int DQ8RBD_2;

	DQ8RBD_2 = (Xil_In32(0xFD080F50U) & 0x003F0000U) >> 0x00000010U;
	int DQ8RBD_3;

	DQ8RBD_3 = (Xil_In32(0xFD080F50U) & 0x3F000000U) >> 0x00000018U;
	int DQ8RBD_4;

	DQ8RBD_4 = (Xil_In32(0xFD080F54U) & 0x0000003FU) >> 0x00000000U;
	int DQ8RBD_5;

	DQ8RBD_5 = (Xil_In32(0xFD080F54U) & 0x00003F00U) >> 0x00000008U;
	int DQ8RBD_6;

	DQ8RBD_6 = (Xil_In32(0xFD080F54U) & 0x003F0000U) >> 0x00000010U;
	int DQ8RBD_7;

	DQ8RBD_7 = (Xil_In32(0xFD080F54U) & 0x3F000000U) >> 0x00000018U;
...
/* declare variables used for calculation */
	...
	cal_byte8 = ((DQ8RBD_0 + DQ8RBD_1 + DQ8RBD_2 + DQ8RBD_3 + DQ8RBD_4 + DQ8RBD_5 + DQ8RBD_6 + DQ8RBD_7)/8);
	...
	prog_reg(0xFD080F58U, 0x0000003FU, 0, cal_byte8);
